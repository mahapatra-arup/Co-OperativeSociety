...
namespace BusinessEntities
{
    class MsgBox :Form
    {
        ...
        private MsgBox()
        {
            ...
            #region _plHeader_DRAG_Event
            _plHeader.MouseMove += _plHeader_MouseMove;
            _plHeader.MouseDown += _plHeader_MouseDown;
            _plHeader.MouseUp += _plHeader_MouseUp;
            #endregion
        }
        #region PNL dRAG

        private void _plHeader_MouseUp(object sender, MouseEventArgs e)
        {
            dragging = false;
        }

        private void _plHeader_MouseDown(object sender, MouseEventArgs e)
        {
            dragging = true;
        ...
        private void _plHeader_MouseMove(object sender, MouseEventArgs e)
        {
            if (dragging)
            {
