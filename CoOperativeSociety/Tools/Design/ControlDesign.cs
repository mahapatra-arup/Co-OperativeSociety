...
{
	///***************************************************************************
///Copy this class and paste  and  build your project and  next going to tollboxlbox where you see many control(button,listvies.tougle,etc)
//********************************************************************************
    #region RoundRect
    ...
    public class IControl_ThemeContainer : ContainerControl
    {
        ...
        public IControl_ThemeContainer()
        {
    ...
    public class IControl_ControlBox : Control
    {
    ...
    class IControl_Button_1 : Control
    {
    ...
    class IControl_Button_2 : Control
    {
    ...
    class IControl_Toggle : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                ...
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.FillPath(Gradient, (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new IControl_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
                G.DrawPath(new Pen(Color.FromArgb(177, 177, 176)), (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new IControl_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
                ...
                {
                    case IControl_Toggle._Type.YesNo:
                        {
                    ...
                    case IControl_Toggle._Type.OnOff:
                        {
                            bool toggled = this.Toggled;
                            if (toggled)
                            {
                    ...
                    case IControl_Toggle._Type.YearlyMonthly:
                        {
                            //****************Text Must be Define  '/' ****************
                            ...
                            if (toggled)
                            {
                                G.DrawString(str[0], new Font("Segoe UI", 7f, FontStyle.Regular), brush, (float)(this.Bar.X+7 ), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
                            ...
                            {
                                G.DrawString(str[1], new Font("Segoe UI", 7f, FontStyle.Regular), brush, (float)(this.Bar.X+18 ), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
    ...
    class IControl_Label : Label
    {

        public IControl_Label()
        {
    ...
    class IControl_LinkLabel : LinkLabel
    {

        public IControl_LinkLabel()
        {
            Font = new Font("Segoe UI", 8, FontStyle.Regular);
            BackColor = Color.Transparent;
    ...
    class IControl_HeaderLabel : Label
    {

        public IControl_HeaderLabel()
        {
    ...
    class IControl_TextBox_Big : Control
    {
        #region Variables

        public TextBox IControlTB = new TextBox();
        private GraphicsPath Shape;
        ...
        public int MaxLength
        {
            ...
            {
                _maxchars = value;
                IControlTB.MaxLength = MaxLength;
                Invalidate();
            }
        }
        ...
        public bool UseSystemPasswordChar
        {
            ...
            set
            {
                IControlTB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (IControlTB != null)
                {
                    IControlTB.Multiline = value;

                    if (value)
                    {
                        IControlTB.Height = Height - 23;
                    }
                    else
                    {
                        Height = IControlTB.Height + 23;
                    }
                }
        ...
        public Image Image
        {
            ...
            set
            {
                ...
                if (Image == null)
                {
                    IControlTB.Location = new Point(8, 10);
                }
                else
                {
                    IControlTB.Location = new Point(35, 11);
                }
                Invalidate();
            }
        }
        ...
        {
            base.OnTextChanged(e);
            IControlTB.Text = Text;
            Invalidate();
        }

        private void OnBaseTextChanged(object s, EventArgs e)
        {
            Text = IControlTB.Text;
        }

        protected override void OnForeColorChanged(System.EventArgs e)
        {
            base.OnForeColorChanged(e);
            IControlTB.ForeColor = ForeColor;
            Invalidate();
        }
        ...
        public void AddTextBox()
        {
            ...
            _TB.Multiline = false;
            IControlTB.KeyDown += _OnKeyDown;
            IControlTB.TextChanged += OnBaseTextChanged;
        }

        public IControl_TextBox_Big()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);

            AddTextBox();
            Controls.Add(IControlTB);
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Image == null)
            {
                IControlTB.Width = Width - 18;
            }
            else
            {
                IControlTB.Width = Width - 45;
            }

            IControlTB.TextAlign = TextAlignment;
            IControlTB.UseSystemPasswordChar = UseSystemPasswordChar;
    ...
    [DefaultEvent("TextChanged")]
    class IControl_TextBox_Small : Control
    {
        #region Variables
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (IControlTB != null)
                {
                    ...
                    if (value)
                    {
                        IControlTB.Height = Height - 10;
                    }
                    else
                    {
                        Height = IControlTB.Height + 10;
                    }
                }
            }
        }
    ...
    [DefaultEvent("TextChanged")]
    class IControl_RichTextBox : Control
    {

        #region Variables

        public RichTextBox IControlRTB = new RichTextBox();
        private bool _ReadOnly;
        ...
        {
            get { return IControlRTB.Text; }
            set
            {
                IControlRTB.Text = value;
                Invalidate();
            }
        }
        public bool ReadOnly
        ...
        public bool AutoWordSelection
        {
            ...
            set
            {
                ...
                if (IControlRTB != null)
                {
                    IControlRTB.AutoWordSelection = value;
                }
            }
        }
        #endregion
        ...
        {
            base.OnForeColorChanged(e);
            IControlRTB.ForeColor = ForeColor;
            Invalidate();
        }
        ...
        {
            base.OnSizeChanged(e);
            IControlRTB.Size = new Size(Width - 13, Height - 11);
        }
    ...
    public class IControl_NumericUpDown : Control
    {
    ...
    public class IControl_ChatBubble_L : Control
    {
    ...
    public class IControl_ChatBubble_R : Control
    {
    ...
    public class IControl_Separator : Control
    {

        public IControl_Separator()
        {
    ...
    class IControl_Panel : ContainerControl
    {


        private GraphicsPath Shape;
        public IControl_Panel()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
    ...
    public class IControl_GroupBox : ContainerControl
    {

        public IControl_GroupBox()
        {
    ...
    class IControl_CheckBox : Control
    {
    ...
    [DefaultEvent("CheckedChanged")]
    class IControl_RadioButton : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(_Control, this) && _Control is IControl_RadioButton)
                {
                    ((IControl_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    class IControl_NotificationNumber : Control
    {
        #region Variables
        ...
        public IControl_NotificationNumber()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
    ...
    class IControl_Listview : ListView
    {

        [DllImport("uxtheme", CharSet = CharSet.Unicode)]
        public static extern int SetWindowTheme(IntPtr hWnd, string textSubAppName, string textSubIdList);

        public IControl_Listview()
        {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            IControl_Listview.SetWindowTheme(this.Handle, "explorer", null);
            base.OnHandleCreated(e);
        }
    }
    ...
    class IControl_ComboBox : ComboBox
    {
    ...
    public class IControl_ProgressBar : Control
    {
    ...
    class IControl_ProgressIndicator : Control
    {
        ...
        public IControl_ProgressIndicator()
        {
    ...
    class IControl_TabControl : TabControl
    {
    ...
    class IControl_TrackBar : Control
    {
    ...
    public class IControl_MenuStrip : MenuStrip
    {

        public IControl_MenuStrip()
        {
    ...
    public class IControl_ContextMenuStrip : ContextMenuStrip
    {

        public IControl_ContextMenuStrip()
        {
            this.Renderer = new ControlRenderer();
        }
    ...
    public class IControl_StatusStrip : StatusStrip
    {

        public IControl_StatusStrip()
        {
            this.Renderer = new ControlRenderer();
            SizingGrip = false;
        }
    ...
    class IControl_Icon_Info : Control
    {
        public IControl_Icon_Info()
        {
    ...
    class IControl_Icon_Tick : Control
    {

        public IControl_Icon_Tick()
        {
            this.ForeColor = Color.DimGray;
            this.BackColor = Color.FromArgb(246, 246, 246);
            this.Size = new Size(33, 33);
    ...
    #region TabControl Horizontal

    //class IControl_TabControl_H : TabControl
    //{
