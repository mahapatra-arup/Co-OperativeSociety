...
namespace CoOperativeSociety.IncomeExpence
{
    public partial class IncomeEntry : Form
    {
        ...
        public IncomeEntry()
        {
            ...
            //Income ledger
            cmbLedgerHead.AddLedger(LedgerEnum._LedgerAttributes.Type, LedgerEnum._LedgerTypeValues.Income);
            ...
            //Set slNo
            txtNo.Text = transectionBA.GenerateIncomeNoOfTransection().ConvertObjectToString();
        }
        ...
        private void FillFromValues(out List<Transection> lstTransection)
        {
            ...
            //To
            Guid paidToLedger = ((KeyValuePair<Guid, string>)cmbIssueTo.SelectedItem).Key;
            ...
            lstTransection.Add(new Transection
            {
                ...
                No = txtNo.Text,
                TransectionType = TransectionEnum._TransectionTypeValues.Income.GetEnumName(),

                //Ledger
                LedgerIdTo = acHeadLedger,
                LedgerIdFrom = paidToLedger,
        ...
        private void Save()
        {
            ...
            if (lstTransection.IsValidList())
            {
                if (!transectionBA.IsExistTransection_Ref_No(txtTransectionRefNo.Text))
                {
                    ...
                    {
                        MessageBox.Show("Transection Successfull", "Income", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ClearData();
                    }
                }
                else
        ...
        private void CashBankControl()
        {
            ...
            switch (cmbPaymentMethod.Text.ToUpper())
            {
                case "CASH":
                    ...
                    cmbIssueTo.AddLedger(LedgerEnum._LedgerAttributes.Category, LedgerEnum._LedgerCategoryValues.Cash);
                    break;
                case "CHEQUE":
                case "RTGS":
                case "NEFT":
                case "IMPS":
                case "UPI":
                    cmbIssueTo.AddLedger(LedgerEnum._LedgerAttributes.Category, lstSocityBankAttribute);
        ...
        private bool IsValid()
        {
            ...
            if (cmbIssueTo.Text.ISNullOrWhiteSpace())
            {
