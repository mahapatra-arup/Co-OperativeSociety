    ...
    public class SqlHelper
    {
        ...
        public static SqlHelper GetInstance()
        {
            if (mInstance == null)
            {
                ...
                mDBUserName = System.Configuration.ConfigurationManager.AppSettings["UserId"].ToString();
        ...
        public static bool TestDBConnection(string _ConnString)
        {
            using (SqlConnection cn = new SqlConnection(_ConnString))
            {
                ...
                {
                    string errorQuery = Environment.NewLine + Environment.NewLine +
                            "================ Error Query===========" + Environment.NewLine +
                            "Query : - " + query;

                    ex.ToWriteLog(Environment.StackTrace , errorQuery);
                    msg = ex.Message;
        ...
        {
            string _CurrentExecuteQuery = string.Empty;
            if (lstQuery.Count > 0)
            {
                int index = 0;
                ...
                using (SqlConnection con = new SqlConnection(CONNECTION_STRING))
                {
                    try
                    {
                        ...
                        {
                            _CurrentExecuteQuery= item.ToString();
